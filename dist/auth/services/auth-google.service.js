...
let AuthGoogleService = class AuthGoogleService {
    constructor(configService) {
        ...
        this.google = new google_auth_library_1.OAuth2Client(configService.get('google.clientId'), configService.get('google.clientSecret'));
    }
